# NukeEngine License, Version 1.0
...
3. **Plugins.** You may create, use, distribute, and **sell** Plugins, including proprietary,
   closed-source ones, on Your own terms (see Section 8).
...
Attribution and modification-disclosure conditions (Section 4).
...
as a different or original engine (Section 5.3).
...
This License does not grant rights in the "NukeEngine" or "Luastris" names or logos, except
for the factual attribution required by Section 4.1.
